...
export class PracticeTestsComponent {
  ...
  mathsQuestions = [
    ...
    {
      question:
        'If a triangle has angles of 90°, 45°, and x°, what is the value of x?',
      options: ['30°', '45°', '60°', '75°'],
      selectedOption: null,
    },
    {
      question: 'Simplify: 4 + 6 × (9 - 3)',
      options: ['28', '34', '40', '46'],
      selectedOption: null,
    },
    {
    ...
    },
    {
      ...
      options: ['25', '49', '81', '144'],
      selectedOption: null,
    },
    {
      question:
        'If an item costs £15.75 and is reduced by 20%, what is the new price?',
      options: ['£12.60', '£12.80', '£13.00', '£14.00'],
      selectedOption: null,
    },
    {
  ...
  scienceQuestions = [
    ...
    {
      question: 'Which force keeps objects on the Earth’s surface?',
  ...
  private startTimer() {
    let countdownSeconds =
      this.hoursDisplay * 3600 + this.minutesDisplay * 60 + this.secondsDisplay;
